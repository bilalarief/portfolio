        ...
        <div className="container max-w-[1180px] grid grid-cols-12 flex justify-between items-center my-auto max-sm:hidden">
          <div className="content col-span-7 gap-8 grid">
            <div className="container flex items-center gap-3">
              <img
                src="/img/works/onlinegps/logo-onlinegps.png"
                alt="Logo onlinegps"
              ></img>
              <p>•</p>
            ...
            <p className="text-xl leading-[140%] paragraph-text">
              OnlineGPS is a GPS tracking system designed to monitor and manage
          ...
          <div className="col-start-9 col-span-4 rounded-[16px] w-full h-[393px] bg-cover bg-[url('/img/works/onlinegps/thumbnail.png')]"></div>
        </div>
        <div className="container max-w-[1180px] grid py-16 items-center my-auto sm:hidden">
          <div className="rounded-[16px] w-full h-[240px] bg-cover bg-[url('/img/works/onlinegps/thumbnail.png')]"></div>
