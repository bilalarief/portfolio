        ...
        <div className="container max-w-[1180px] grid grid-cols-12 flex justify-between items-center my-auto max-sm:hidden">
          <div className="content col-span-7 gap-8 grid">
            <div className="container flex items-center gap-3">
              <img
                src="/img/works/beliesim/logo-beliesim.svg"
                alt="Logo Beliesim"
              ></img>
              <p>•</p>
            ...
            <p className="text-xl leading-[140%] paragraph-text">
              Beliesim provide electronic SIM (eSIM) for customers who want to
              travel around the world with super hassle-free & affordable
              connectivity
            </p>
            <a
              href="https://affiliate.beliesim.com/"
              target="_blank"
          ...
          <div className="col-start-9 col-span-4 rounded-[16px] w-full h-[393px] bg-cover bg-[url('/img/works/beliesim/thumbnail.png')]"></div>
        </div>
        <div className="container max-w-[1180px] grid py-16 items-center my-auto sm:hidden">
          <div className="rounded-[16px] w-full h-[240px] bg-cover bg-[url('/img/works/beliesim/thumbnail.png')]"></div>
