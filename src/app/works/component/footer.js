...
export default function footer() {
  return (
    <footer className="bg-noise pt-40 pb-10 px-10 ">
      <div className="container max-w-[1180px]">
        <div className="top">
          <h1 className="sm:text-5xl text-white mb-6 text-[2.3rem]">
            I'm always open to new and interesting opportunities.
          </h1>
          <a
        ...
        <div className="bottom mt-20 gap-6 flex">
          <a
            href="https://www.linkedin.com/in/bilalarief/"
            target="_blank"
            className="text-[#A6A6A6] hover:text-[#F5F5F5]"
          >
            LinkedIn
          </a>
          <a
          ...
          <a
            href="https://dribbble.com/bilalarief"
            target="_blank"
            className="text-[#A6A6A6] hover:text-[#F5F5F5]"
          >
            Dribbble
